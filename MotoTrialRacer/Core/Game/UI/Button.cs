    ...
    class Button : IDrawable
    {
                      ...
                      ContentManager contentManager, bool isTexture)
        {
            ...
            else
            {
				...
				RenderTarget2D renderTarget = new RenderTarget2D(MotoTrialRacerGame.Graphics.GraphicsDevice, width, height);
				SpriteBatch spriteBatch = new SpriteBatch(MotoTrialRacerGame.Graphics.GraphicsDevice);
